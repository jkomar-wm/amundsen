...
def connection_string():
    user = config['UAT-REDSHIFT-USER']
    host = config['UAT-REDSHIFT-HOST']
    port = config['UAT-REDSHIFT-PORT']
    db = config['UAT-REDSHIFT-DB-NAME']
    password = config['UAT-REDSHIFT-PASS']
...
def run_redshift_job(schema):
    ...
    job_config = ConfigFactory.from_dict({
        ...
        f'extractor.redshift_metadata.{RedshiftMetadataExtractor.CLUSTER_KEY}': 'UAT-REDSHIFT-DB',
