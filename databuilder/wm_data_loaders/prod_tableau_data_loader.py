...
tableau_site_name = "weedmapstableau"
tableau_personal_access_token_name = config['TABLEAU_TOKEN_NAME_JKOMAR']
tableau_personal_access_token_secret = config['TABLEAU_TOKEN_SECRET']
