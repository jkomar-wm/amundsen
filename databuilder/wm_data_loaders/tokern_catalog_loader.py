...
es = Elasticsearch([{"host": es_host or "localhost"}])
...
# tokern_connection = {"path": "/Users/jkomar/.config/tokern/catalog.db", "secret": "TOKERN_CATALOG_SECRET"}
tokern_connection = {
    "user": "postgres",
    "password": "docker",
    "host": "localhost",
...
def extract_catalog_job():
    ...
    job = DefaultJob(
        conf=job_config,
        task=DefaultTask(extractor=CatalogExtractor(), loader=FsNeo4jCSVLoader()),
...
if __name__ == "__main__":
    ...
    loading_job = extract_catalog_job()
    loading_job.launch()
